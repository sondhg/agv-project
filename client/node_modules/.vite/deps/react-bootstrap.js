...
import {
  ...
  useWaitForDOMRef,
  useWillUnmount
} from "./chunk-WV7LD6EZ.js";
import {
  ENTERING,
  EXITING,
  hasClass
} from "./chunk-5YH46W2U.js";
import {
  require_react_dom
} from "./chunk-GJ5PGLZ3.js";
import {
  divWithClassName_default
} from "./chunk-ROBGYADM.js";
import {
...
import {
  NavItem_default,
  Nav_default
} from "./chunk-INU4FV5W.js";
import "./chunk-7644ZO4T.js";
import "./chunk-CUV7YZ5O.js";
import {
  Anchor_default,
  NavLink_default
} from "./chunk-QVR5XL4L.js";
import "./chunk-SRFG2YRZ.js";
import {
  TabContext_default
} from "./chunk-ZWBKKFSG.js";
import {
...
var Feedback = React26.forwardRef(
  ...
  ({
    ...
    tooltip = false,
    ...props
  }, ref) => (0, import_jsx_runtime27.jsx)(Component2, {
    ...props,
    ref,
...
var FormCheckLabel = React29.forwardRef(({
  ...
  return (0, import_jsx_runtime29.jsx)("label", {
    ...props,
    ref,
...
var FormCheck = React30.forwardRef(({
  ...
  const input = (0, import_jsx_runtime30.jsx)(FormCheckInput_default, {
    ...props,
  ...
  return (0, import_jsx_runtime30.jsx)(FormContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime30.jsx)("div", {
      ...
      children: children || (0, import_jsx_runtime32.jsxs)(import_jsx_runtime31.Fragment, {
        children: [input, hasLabel && (0, import_jsx_runtime30.jsx)(FormCheckLabel_default, {
          title,
          children: label
        }), feedback && (0, import_jsx_runtime30.jsx)(Feedback_default, {
          type: feedbackType,
...
var FormControl = React31.forwardRef(({
  ...
  return (0, import_jsx_runtime33.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames26.default)(className, plaintext ? `${bsPrefix}-plaintext` : bsPrefix, size && `${bsPrefix}-${size}`, type === "color" && `${bsPrefix}-color`, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var Switch = React38.forwardRef((props, ref) => (0, import_jsx_runtime40.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime55.jsxs)(import_jsx_runtime54.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react22.cloneElement)(children, triggerProps), (0, import_jsx_runtime53.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var Pagination = React52.forwardRef(({
  ...
  return (0, import_jsx_runtime58.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames42.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames43.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var TabContent = React63.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime73.jsxs)(Tabs_default, {
    ...
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime72.jsx)(Nav_default, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
