...
} from "./chunk-VODV6RQP.js";
import {
  Anchor_default,
  NavLink_default,
  TabContext_default,
  useNavItem
} from "./chunk-2W77XEYX.js";
import {
...
var FormControl = React32.forwardRef(({
  ...
  return (0, import_jsx_runtime34.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames27.default)(className, plaintext ? `${bsPrefix}-plaintext` : bsPrefix, size && `${bsPrefix}-${size}`, type === "color" && `${bsPrefix}-color`, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
